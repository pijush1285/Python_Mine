...
This virson will include the theta calculation with it.
...
# When using the open syncmer then we have to use the value of t location.
#t = 5
...
#Write all records
sub_dir5 = dir5
absolute_output_path5 = os.path.join(cwd, main_output_dir,sub_dir5)
