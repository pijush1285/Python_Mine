...
directory_name = 'seedsk'+ str(kmer) +'s'+ str(smer)+'t'+ str(t)
...
dir5 =  'Theta'
path = os.getcwd()+'/seedsk'+ str(kmer) +'s'+ str(smer)+'t'+ str(t)+'/'
...
for i in tqdm(range(100)):
    ...
    try:
        h = jls_submer_clt_mgr.to_syncmer_open_Wilson_score_intervals_for_theta( count_of_submers, count_of_unmutated_syncmers, alpha_0, k, s, t1) #, length 
    ...
    #s = 6
    try:
        h1 = jls_submer_clt_mgr.to_syncmer_open_Wilson_score_intervals_for_theta( count_of_submers1, count_of_unmutated_syncmers1, alpha_0, k, s, t1) #, length 
    ...
    #s = 6
    try:
        h2 = jls_submer_clt_mgr.to_syncmer_open_Wilson_score_intervals_for_theta( count_of_submers2, count_of_unmutated_syncmers2, alpha_0, k, s, t1) #, length 
...
df1r.to_excel(absolute_output_path5+"/Thetak"+str(kmer)+"s"+str(smer)+"t"+str(t)+"P0.05_n1k.xlsx") 
df1r.to_csv(absolute_output_path5+"/Thetak"+str(kmer)+"s"+str(smer)+"t"+str(t)+"P0.05_n1k.txt")
#Write all records
df2r.to_excel(absolute_output_path5+"/Thetak"+str(kmer)+"s"+str(smer)+"t"+str(t)+"P0.15_n1k.xlsx") 
df2r.to_csv(absolute_output_path5+"/Thetak"+str(kmer)+"s"+str(smer)+"t"+str(t)+"P0.15_n1k.txt") 
#Write all records
df3r.to_excel(absolute_output_path5+"/Thetak"+str(kmer)+"s"+str(smer)+"t"+str(t)+"P0.25_n1k.xlsx") 
df3r.to_csv(absolute_output_path5+"/Thetak"+str(kmer)+"s"+str(smer)+"t"+str(t)+"P0.25_n1k.txt") 
