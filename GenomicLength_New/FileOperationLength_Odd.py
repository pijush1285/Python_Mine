...
count = 1
for xx in range(100):
   # filename="C:/Users/dasp5.NCBI_NT/Desktop/Out/Genome Length New Analysis Scripts/Results20k/1.st_100_simulated/FileOperationResults_"+str(count)+".txt"
   # filename="C:/Users/dasp5.NCBI_NT/Desktop/Out/Genome Length New Analysis Scripts/Results20k/2.st_100_simulated/FileOperationResults_"+str(count)+".txt"
   # filename="C:/Users/dasp5.NCBI_NT/Desktop/Out/Genome Length New Analysis Scripts/Results20k/3.st_100_simulated/FileOperationResults_"+str(count)+".txt"
   # filename="C:/Users/dasp5.NCBI_NT/Desktop/Out/Genome Length New Analysis Scripts/Results20k/4.st_100_simulated/FileOperationResults_"+str(count)+".txt"
   # filename="C:/Users/dasp5.NCBI_NT/Desktop/Out/Genome Length New Analysis Scripts/Results20k/5.st_100_simulated/FileOperationResults_"+str(count)+".txt"
   # filename="C:/Users/dasp5.NCBI_NT/Desktop/Out/Genome Length New Analysis Scripts/Results20k/6.st_100_simulated/FileOperationResults_"+str(count)+".txt"
   # filename="C:/Users/dasp5.NCBI_NT/Desktop/Out/Genome Length New Analysis Scripts/Results20k/7.st_100_simulated/FileOperationResults_"+str(count)+".txt"
   # filename="C:/Users/dasp5.NCBI_NT/Desktop/Out/Genome Length New Analysis Scripts/Results20k/8.st_100_simulated/FileOperationResults_"+str(count)+".txt"
   # filename="C:/Users/dasp5.NCBI_NT/Desktop/Out/Genome Length New Analysis Scripts/Results20k/9.st_100_simulated/FileOperationResults_"+str(count)+".txt"
    filename="C:/Users/dasp5.NCBI_NT/Desktop/Out/Genome Length New Analysis Scripts/Results20k/10.st_100_simulated/FileOperationResults_"+str(count)+".txt"
...
#Write all records
#cd C:\Users\dasp5.NCBI_NT\Desktop\Out\Genome Length New Analysis Scripts\Results20k\ProcessedOnText
