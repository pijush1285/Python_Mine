...
#folder="C:/Users/dasp5.NCBI_NT/Desktop/Out/Genome Length New Analysis Scripts/Results20k"
#folder="C:/Users/dasp5.NCBI_NT/Desktop/Out/Genome Length New Analysis Scripts/Result10L"
#folder="C:/Users/dasp5.NCBI_NT/Desktop/Out/Genome Length New Analysis Scripts/Result1L"
#folder="C:/Users/dasp5.NCBI_NT/Desktop/Out/Genome Length New Analysis Scripts/Result10k"
#folder="C:/Users/dasp5.NCBI_NT/Desktop/Out/Genome Length New Analysis Scripts/Result1k"
#folder="C:/Users/dasp5.NCBI_NT/Desktop/Out/Genome Length New Analysis Scripts/Result100"
folder="C:/Users/dasp5.NCBI_NT/Desktop/Out\Genome Length New Analysis Scripts/OpenSyncmerResults/5.Length_10L/ReAnalysis"
...
for yy in range(10):
    ...
    for xx in range(100):
        if yy == 0:
            filename=str(folder)+"/1.st_100_simulated/FileOperationResults_"+str(count)+".txt"
        if yy == 1: 
            filename=str(folder)+"/2.st_100_simulated/FileOperationResults_"+str(count)+".txt"
        if yy == 2: 
            filename=str(folder)+"/3.st_100_simulated/FileOperationResults_"+str(count)+".txt"
        if yy == 3: 
            filename=str(folder)+"/4.st_100_simulated/FileOperationResults_"+str(count)+".txt"
        if yy == 4: 
            filename=str(folder)+"/5.st_100_simulated/FileOperationResults_"+str(count)+".txt"
        if yy == 5: 
            filename=str(folder)+"/6.st_100_simulated/FileOperationResults_"+str(count)+".txt"
        if yy == 6: 
            filename=str(folder)+"/7.st_100_simulated/FileOperationResults_"+str(count)+".txt"
        if yy == 7: 
            filename=str(folder)+"/8.st_100_simulated/FileOperationResults_"+str(count)+".txt"
        if yy == 8: 
            filename=str(folder)+"/9.st_100_simulated/FileOperationResults_"+str(count)+".txt"
        if yy == 9: 
            filename=str(folder)+"/10.st_100_simulated/FileOperationResults_"+str(count)+".txt"
...
#Write all records
#cd C:\Users\dasp5.NCBI_NT\Desktop\Out\Genome Length New Analysis Scripts\OpenSyncmerResults\5.Length_10L\ReAnalysis\ProcessedOnText
...
df5_2x.columns = ['SL','k-mer', 'syn-window', 's', 'seed', 'LengthLow', 'LengthHigh', 'filename']
df5_2x.to_excel(writer, sheet_name='Sheet1')
df5_3x = df5_3[0].str.split(',', expand=True)
df5_3x.columns = ['SL','k-mer', 'syn-window', 's', 'seed', 'LengthLow', 'LengthHigh', 'filename']
...
df10_2x.columns = ['SL','k-mer', 'syn-window', 's', 'seed', 'LengthLow', 'LengthHigh', 'filename']
df10_2x.to_excel(writer1, sheet_name='Sheet1')
df10_3x = df10_3[0].str.split(',', expand=True)
df10_3x.columns = ['SL','k-mer', 'syn-window', 's', 'seed', 'LengthLow', 'LengthHigh', 'filename']
df10_3x.to_excel(writer1, sheet_name='Sheet2')
df10_4x = df10_4[0].str.split(',', expand=True)
df10_4x.columns = ['SL','k-mer', 'syn-window', 's', 'seed', 'LengthLow', 'LengthHigh', 'filename']
df10_4x.to_excel(writer1, sheet_name='Sheet3')
df10_5x = df10_5[0].str.split(',', expand=True)
df10_5x.columns = ['SL','k-mer', 'syn-window', 's', 'seed', 'LengthLow', 'LengthHigh', 'filename']
df10_5x.to_excel(writer1, sheet_name='Sheet4')
df10_6x = df10_6[0].str.split(',', expand=True)
df10_6x.columns = ['SL','k-mer', 'syn-window', 's', 'seed', 'LengthLow', 'LengthHigh', 'filename']
...
df15_2x.columns = ['SL','k-mer', 'syn-window', 's', 'seed', 'LengthLow', 'LengthHigh', 'filename']
df15_2x.to_excel(writer2, sheet_name='Sheet1')
df15_3x = df15_3[0].str.split(',', expand=True)
df15_3x.columns = ['SL','k-mer', 'syn-window', 's', 'seed', 'LengthLow', 'LengthHigh', 'filename']
df15_3x.to_excel(writer2, sheet_name='Sheet2')
df15_4x = df15_4[0].str.split(',', expand=True)
df15_4x.columns = ['SL','k-mer', 'syn-window', 's', 'seed', 'LengthLow', 'LengthHigh', 'filename']
df15_4x.to_excel(writer2, sheet_name='Sheet3')
df15_5x = df15_5[0].str.split(',', expand=True)
df15_5x.columns = ['SL','k-mer', 'syn-window', 's', 'seed', 'LengthLow', 'LengthHigh', 'filename']
df15_5x.to_excel(writer2, sheet_name='Sheet4')
df15_6x = df15_6[0].str.split(',', expand=True)
df15_6x.columns = ['SL','k-mer', 'syn-window', 's', 'seed', 'LengthLow', 'LengthHigh', 'filename']
df15_6x.to_excel(writer2, sheet_name='Sheet5')
df15_7x = df15_7[0].str.split(',', expand=True)
df15_7x.columns = ['SL','k-mer', 'syn-window', 's', 'seed', 'LengthLow', 'LengthHigh', 'filename']
df15_7x.to_excel(writer2, sheet_name='Sheet6')
df15_8x = df15_8[0].str.split(',', expand=True)
df15_8x.columns = ['SL','k-mer', 'syn-window', 's', 'seed', 'LengthLow', 'LengthHigh', 'filename']
...
dataframe1 = pd.read_excel('Result1st100kmer5.xlsx')
holder1 = dataframe1[0].str.split(',', expand=True)
holder1.columns = ['SL','k-mer', 'syn-window', 's', 'seed', 'LengthLow', 'LengthHigh', 'filename']

dataframe2 = pd.read_excel('Result1st100kmer5.xlsx', sheet_name="Sheet2")
holder2 = dataframe2[0].str.split(',', expand=True)
holder2.columns = ['SL','k-mer', 'syn-window', 's', 'seed', 'LengthLow', 'LengthHigh', 'filename']

dataframe3 = pd.read_excel('Result1st100kmer5.xlsx', sheet_name="Sheet3")
holder3 = dataframe3[0].str.split(',', expand=True)
holder3.columns = ['SL','k-mer', 'syn-window', 's', 'seed', 'LengthLow', 'LengthHigh', 'filename']

writer6 = pd.ExcelWriter('Result1st100kmer5v1.xlsx', engine='xlsxwriter')
xx.to_excel(writer6, sheet_name = 'Sheet1') 
holder2.to_excel(writer6, sheet_name = 'Sheet2') 
holder3.to_excel(writer6, sheet_name = 'Sheet3') 
writer6.save()
