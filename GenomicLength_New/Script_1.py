...
var = 0
for xx in range(100):
    filename="/home/dasp5/dataset/OpenSyncmer/5.Length_10L/9.st_100_simulated/seed_9/Results_RGID_"+str(count)+".txt"
    ...
    for x in range(len(Lines)):
        ...
        if per_word[1] == 'dna-seed-sim':
            ...
            filename = per_word[7].split('/')[7] # Need to be collected 'RGID_1.fasta'
