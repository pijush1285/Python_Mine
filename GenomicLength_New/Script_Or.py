...
sys.path.insert(0,"C:/Users/dasp5.NCBI_NT/Desktop/Out/Genome Length New Analysis Scripts/Script Open Syncmer/New/new/submer-central-limit-theorem-main/modules") # My laptop
...
var = 0
for xx in range(100):
    filename="C:/Users/dasp5.NCBI_NT/Desktop/Out/Genome Length New Analysis Scripts/Script Open Syncmer/New/new/Results_RGID_"+str(count)+".txt"
