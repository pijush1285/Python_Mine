...
import pandas as pd
import sys
sys.path.append('./submer-central-limit-theorem/modules')
...
count = 1
for xx in range(100):
    filename="/home/dasp5/dataset/RandomSimulated/1.st_100_simulated/LengthAuto_1/Results_RGID_"+str(count)+".txt"
