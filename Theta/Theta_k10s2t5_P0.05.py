...
for xx in range(1000):
    #Raw Seed file read.
    RawSeed = pd.read_csv("/home/dasp5/dataset/Table3/1_Dataset_0.1kby1k/seeds_open/1_Raw_seed/RawSeed_"+str(count)+".csv",header=1, sep='\t') 
    # Mutated file read.
    MutSeed = pd.read_csv("/home/dasp5/dataset/Table3/1_Dataset_0.1kby1k/seeds_open/2_Mutated_0.05_seed/Mut_0.05Seed_"+str(count)+".csv",header=1,sep='\t')
 ...
 #Write all records
df.to_excel("./ResultsThetak21P0.05_n1000_v1.xlsx") 
df.to_csv("./ResultsThetak21P0.05_n1000_v1.txt") 
