...
for xx in range(1000):
    ...
    # Mutated file read.
    MutSeed = pd.read_csv("/home/dasp5/dataset/Table2Analysis/Dataset_100kby_1k/seeds/seed_21/Mut_0.1_seed/Mut_0.1Seed_"+str(count)+".csv",header=1,sep='\t')
    ...
    df1 = pd.DataFrame({'k-mer' :[k],
               ...
               'filename': ["Mut_0.1Seed_"+str(count)+".csv"]})
 ...
 #Write all records
df.to_excel("./ResultsThetak21P0.1_n1000.xlsx") 
df.to_csv("./ResultsThetak21P0.1_n1000.txt") 
